...
# meta_db.set('stat:wiki_parsed', 0)    # set parsing counter to 0

# MongoDB initialise (remove all existing collections)
...
relation_collection.create_index([('en1id', pymongo.ASCENDING), ('en2id', pymongo.ASCENDING)])
